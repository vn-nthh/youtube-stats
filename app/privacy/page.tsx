    ...
    <div className="min-h-screen bg-background p-4">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground">YouTube Stat Tracker Data Handling Policy</p>
        </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <section>
              ...
              <ul className="list-disc list-inside body-text space-y-2 ml-4">
            ...
            <section>
              ...
              <ol className="list-decimal list-inside body-text space-y-2 ml-4">
            ...
            <section>
              ...
              <div className="bg-muted p-4 rounded-lg">
                ...
                <a 
                  ...
                  className="text-primary hover:text-primary/80 underline font-mono text-sm"
                >
